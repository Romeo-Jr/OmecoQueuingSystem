        ...
        <div id="content">
            ...
            <div class="table-responsive-xl">
                ...
                <?php
                    ...
                    $customeri_email = $_SESSION["email"];

                    $fetch_queue = mysqli_query($con, "SELECT * FROM queue WHERE customer_email = '$customeri_email'");
                    $getNumRows = mysqli_num_rows($fetch_queue);
